    ...
    <div class="row g-4" id="wine-grid">
        <c:forEach var="producto" items="${listaProductos}">
            <div class="col-sm-6 col-md-4 col-lg-3 mb-4 wine-item"
                ...
                <div class="card h-100 border-0 wine-card hover-card">

                    <div class="position-relative">
                        <img src="${producto.url_pro}"
                             class="card-img-top wine-image rounded-top"
                             alt="${producto.nombre_pro}">
                        <span class="card-year badge bg-dark position-absolute top-0 start-0 m-2 px-3 py-2 rounded-pill shadow">
                                ${producto.anio_pro}
                        </span>
                        <span class="badge bg-success position-absolute top-0 end-0 m-2 px-3 py-2 shadow">
                    ...
                    <div class="card-body d-flex flex-column p-3">
                        ...
                        <div class="mb-2">
                                <span class="card-category badge bg-secondary small">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                                <span class="card-price fw-bold text-danger fs-6">
