                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/gestion/productos/guardar" method="post" modelAttribute="nuevoProducto">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nombre_pro" name="nombre_pro"
                                               placeholder="Ej. Vino Tinto" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="descrip_pro" class="form-label">Descripción</label>
                                        <textarea class="form-control" id="descrip_pro" name="descrip_pro" rows="3"
                                                  placeholder="Descripción del producto" required></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="categoria_pro" class="form-label">Categoría</label>
                                        <select class="form-select" id="categoria_pro" name="categoria_pro.id_categoria" required>
                                            <option value selected disabled>Selecciona una categoría</option>
                                            <c:forEach var="cat" items="${categorias}">
                                                <option value="${cat.id_categoria}">${cat.nombre_cate}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="anio_pro" name="anio_pro"
                                               placeholder="Ej. 2022" min="1900" max="2099" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="precio_pro" class="form-label">Precio (S/)</label>
                                        <input type="number" class="form-control" id="precio_pro" name="precio_pro"
                                               placeholder="Ej. 99.99" step="0.01" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="stock_pro" class="form-label">Stock</label>
                                        <input type="number" class="form-control" id="stock_pro" name="stock_pro"
                                               placeholder="Cantidad disponible" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="url_pro" class="form-label">URL de la imagen del producto</label>
                                        <input type="text" class="form-control" id="url_pro" name="url_pro"
                                               placeholder="http://ejemplo.com.jpg" required>
                                    </div>

                                    <div class="d-flex justify-content-between">
                                        <a href="${pageContext.request.contextPath}/gestion/productos" class="btn btn-secondary btn-lg">
