...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/nosotros-css.css">
...
<section id="quienes-somos" class="py-5 bg-gradient">
    <div class="container">
        ...
        <p class="text-center fs-5">
            ...
            dedicada a la producción de vinos artesanales de alta calidad. Combinamos
            la tradición vinícola con técnicas modernas para ofrecer una experiencia
            ...
            <div class="col-md-3">
                <div class="card border-0 py-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted">Amamos lo que hacemos y lo reflejamos en cada vino.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 py-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted">Nuestros vinos cumplen con los más altos estándares.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 py-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted">Estamos comprometidos con clientes y comunidad.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card border-0 py-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted">Buscamos siempre mejorar e innovar en nuestros procesos.</p>
                    </div>
                </div>
            </div>
        </div>
